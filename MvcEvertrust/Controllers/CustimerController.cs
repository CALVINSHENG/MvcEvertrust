...
using MvcEvertrust.Models;
using CFNewDB.Models;

namespace MvcEvertrust.Controllers
{
    public class CustimerController : Controller
    {
        private OpenNorthwind db = new OpenNorthwind();
